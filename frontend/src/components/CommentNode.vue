...
<template>
    ...
    >
        ...
        >
            ...
            />
            <!-- #518 — vote widget extracted to CommentVotes.vue; refresh
                 fan-out stays here (bus emits are CommentNode's concern). -->
            <CommentVotes :msg="msg" @refresh="broadcastRefresh" />
